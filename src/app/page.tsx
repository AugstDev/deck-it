          ...
          <div className="card-color">
            ...
            <div className="front-color">
              ...
              <div className='flex gap-2'>
                <button className='w-10 h-10 bg-gradient-to-br from-[#A855F7] to-[#3B82F6] rounded-[8px]' title='color' type='button'/>
                <button className='w-10 h-10 bg-gradient-to-br from-[#10B981] to-[#14B8A6] rounded-[8px]' title='color' type='button'/>
                <button className='w-10 h-10 bg-gradient-to-br from-[#EC4899] to-[#EF4444] rounded-[8px]' title='color' type='button'/>
                <button className='w-10 h-10 bg-gradient-to-br from-[#F97316] to-[#EAB308] rounded-[8px]' title='color' type='button'/>
                <button className='w-10 h-10 bg-gradient-to-br from-[#4B5563] to-[#1F2937] rounded-[8px]' title='color' type='button'/>
                <button className='w-10 h-10 bg-gradient-to-br from-[#6366F1] to-[#A855F7] rounded-[8px]' title='color' type='button'/>
              </div>
